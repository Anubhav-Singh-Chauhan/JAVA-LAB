...
public class Q19 {
    public static void main(String[] args) {
      ...
      -> If a top-level class is declared as private the compiler will complain that the modifier private
         is not allowed here.This means that a top-level class cannot be a private, the same can be applied
         to protected access specifier also. Protected means that the member can be accessed by any class in the
         same package and by subclasses even if they are in another package.
         */
    }
}
